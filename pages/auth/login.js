  ...
  const login = async (e) => {
    ...
    localStorage.setItem("email", email); 
     ...
     if(localStorage.getItem("email") === "walkingmafia@aura.com"){
      ...
      //save the cipher value to local storage
        ...
        <div className="flex content-center items-center justify-center h-full ">
          <div className="w-full lg:w-4/12 px-4">
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg  bg-white border-0">
              <div className="rounded-t mb-0 px-6 py-6">
                <div className="text-center mb-3">
                  <h6 className="text-blueGray-500 text-sm font-bold hidden">
                    Sign in with
                  </h6>
                </div>
                ...
                <hr className="mt-6 border-b-1 border-blueGray-300 hidden" />
              </div>
                ...
                <form>
                  ...
                  <div className="text-center mt-6">
                    <button
                      ...
                      className="bg-black  text-white active:bg-blue-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                      type="button"
                    >
                      Sign In
                    </button>
            ...
            <div className="flex flex-wrap mt-6 relative hidden">
              ...
              <div className="w-1/2 text-right hidden">
